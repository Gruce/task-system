<div>
    ...
    <li>
        <div class="flex items-center p-2 ">
            <i @if (Request::route()->getName() == 'department') class="fa-solid fa-building-user text-primary-500"
                @else class="fa-solid fa-building-user text-gray-700" @endif></i>
            <a href="{{ route('department') }}" aria-current="page" @if (Request::route()->getName() == 'department') class="block py-2 pr-4 pl-3 text-primary-500 group-hover:text-primary-500 rounded"
                @else class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" @endif>{{ __('ui.departments') }}</a>
        </div>
    </li>
    <li>
        <div class="flex items-center p-2 ">
