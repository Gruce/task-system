                    ...
                    <div>
                        ...
                        <div class="flex w-full gap-2">
                            ...
                            @if ($search)
                                ...
                                <button @click="() => { project=!project, $wire.$set('search', {{null}}) }" class="px-4 py-2.5 duration-150 ease-in-out delay-75 border rounded-lg hover:text-success-800 hover:bg-success-100">
