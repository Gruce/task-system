        ...
        <div class="flex justify-between w-full">
            <div class="flex flex-col">
                <div class="flex items-center gap-2">
                    ...
                    <span>·</span>
                    <span class="text-xs text-secondary-500">Project Name</span>
                </div>
                    ...
                    <div class="flex gap-2 p-6">
                        ...
                        <div class="flex flex-col gap-4 basis-3/4">
                            ...
                            <div x-show="selected == 0" class="relative flex flex-col gap-2 p-4 pt-6 border rounded-lg">
                                ...
                                <p>Task DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask DescriptionTask</p>
                            </div>
