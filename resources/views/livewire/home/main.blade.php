                ...
                <div class="flex lg:flex-row flex-col justify-between">
                    <div class="flex flex-col gap-2 bg-white basis-1/4">
                        ...
                        <div class="flex flex-col gap-4 px-2 m-1 overflow-y-auto h-tasklist">
                            @for ($i = 0; $i < 10; $i++) <a href="www.google.com">
                                            ...
                                            <div class="flex items-center justify-between w-full">
                                                ...
                                                <div class="flex flex-col gap-2 w-1/2 ">
                                                    <div class="flex justify-between mb-1">
                                                        <span class="text-xs font-medium text-secondary-500 ">34%</span>
                                                    </div>
                                                    <div class="w-full bg-gray-200 rounded-full h-1.5">
                                                        <div class="bg-secondary-600 h-1.5 rounded-full" style="width: 23%">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
