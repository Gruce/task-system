...
<div x-cloak class="p-4 sm:p-8" x-data="{ add: false , export: false}">
    <div class="flex justify-between mb-4">
        ...
        <div>
            <button wire:click="export" class="text-white bg-gradient-to-r from-gray-500 via-gray-600 to-gray-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 shadow-lg shadow-gray-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 inline-flex items-center gap-4">
