            ...
            <div class="p-4 h-full bg-white rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-4">
                    <div class="flex flex-col">
                        <div class="flex items-center justify-between mt-3">
                            <div class="flex items-center gap-4  text-secondary-600 group">
                                ...
                                <div class="flex items-center gap-4" @click.stop=""
                                    ...
                                    <input wire:keydown.enter="edit_name" wire:model="employee.user.name" type="text"
                                        x-show="name"
                                        class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                        required>

                                    <div
                                        class="px-2 py-1 duration-200 ease-in-out delay-100 rounded-lg opacity-0 group-hover:opacity-100 hover:text-secondary-800 bg-secondary-50">
                                        <a @click="name = !name" x-show="!name" href="#"><i
                                                class="fas fa-pen"></i></a>
                                        <a wire:click="edit_name" @click="name = !name" x-show="name" href="#"><i
                         ...
                         <div class="flex items-center gap-4  text-secondary-600 group">
                            ...
                            <div class="flex items-center gap-4" @click.stop="" @click.outside="job = false">
                                <input wire:keydown.enter="edit_name" wire:model="employee.job" type="text"
                                    x-show="job"
                                    class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    required>
                                ...
                                <div
                                    class="px-2 py-1 duration-200 ease-in-out delay-100 rounded-lg opacity-0 group-hover:opacity-100 hover:text-secondary-800 bg-secondary-50">
                                    <a @click="job = !job" x-show="!job" href="#"><i
                                            class="fas fa-pen"></i></a>
                                    <a wire:click="edit_name" @click="job = !job" x-show="job" href="#"><i
                                            class="fas fa-check"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4  text-secondary-600 group">
                            ...
                            <div class="flex items-center gap-4" @click.stop="" @click.outside="email = false">
                                <input wire:keydown.enter="edit_name" wire:model="employee.user.email" type="text"
                                    x-show="email"
                                    class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    required>
                                ...
                                <div
                                    class="px-2 py-1 duration-200 ease-in-out delay-100 rounded-lg opacity-0 group-hover:opacity-100 hover:text-secondary-800 bg-secondary-50">
                                    <a @click="email = !email" x-show="!email" href="#"><i
                                            class="fas fa-pen"></i></a>
                                    <a wire:click="edit_name" @click="email = !email" x-show="email" href="#"><i
                                            class="fas fa-check"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4  text-secondary-600 group">
                            ...
                            <div class="flex items-center gap-4" @click.stop="" @click.outside="phone = false">
                                <input wire:keydown.enter="edit_name" wire:model="employee.user.phonenumber" type="text"
                                    x-show="phone"
                                    class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    required>
                                ...
                                <div
                                    class="px-2 py-1 duration-200 ease-in-out delay-100 rounded-lg opacity-0 group-hover:opacity-100 hover:text-secondary-800 bg-secondary-50">
                                    <a @click="phone = !phone" x-show="!phone" href="#"><i
                                            class="fas fa-pen"></i></a>
                                    <a wire:click="edit_name" @click="phone = !phone" x-show="phone" href="#"><i
                                            class="fas fa-check"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                            class="absolute  bottom-1  left-9  w-5.5 h-5.5 text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-lg p-1 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
