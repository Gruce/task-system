    ...
    <div class="p-3 text-right bg-white rounded-lg w-fulldark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="max-w-sm bg-white rounded-lg  dark:bg-gray-800">
            ...
            <div class="flex flex-col items-center pb-10">
                ...
                <img class="mb-3 w-24 h-24 rounded-full shadow-lg" src="{{ asset($employee->user->profile_photo) }}" alt="Bordered avatar">
                @else
                ...
                @endif
                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{$employee->user->name}}</h5>
