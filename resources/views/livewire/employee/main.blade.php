    ...
    <div x-cloak class="p-4" x-data="{ addEmployee: false, gridEmployee:false, deleteEmployee:false,reportEmployee:false }">
        <div class="flex justify-between mb-4">
            ...
            <div class="flex gap-4">
                ...
                @admin()
                <button x-show="!deleteEmployee" @click="deleteEmployee = !deleteEmployee" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2 inline-flex items-center gap-4">
                    <i class="fa-solid fa-trash"></i>
                    {{__('ui.delete')}}
                </button>
                <button x-show="!reportEmployee" @click="reportEmployee = !reportEmployee" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2 inline-flex items-center gap-4">
